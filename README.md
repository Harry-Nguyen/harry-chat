# Homework 2 - Harry-chat

Harry-chat is a Ruby on Rails blog application that allows users to send messages to each other that can only be read once.

Submitted by: Dat Nguyen

Time spent: 6 hours

URL: https://harrychat.herokuapp.com/
